...
function calcEventFinancialsFromFields(){
  ...
  const extras=parseNum($('f_extras')?.value);
  const base=(pessoas*valorPessoa)+extras;
...
function setupEventFinancials(){
  ['f_pessoas','f_valorPessoa','f_extras','f_taxa'].forEach(id=>{

...
function _flTotalDiarias(fl){
  const bruto = parseInt(fl?.totalDiarias || fl?.dias || 8) || 8;
  // No modelo atual todo freelance trabalha em pacote padrão de 8 campos.
  // Registros antigos podiam vir com 1 ou 2 dias do modelo legado; aqui fazemos o upgrade automático.
